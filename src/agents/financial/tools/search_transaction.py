...
class SearchTransactionsTool(BaseTool):
    ...
    args_schema: type[BaseModel] = SearchTransactionParams
    description: str = (
    ...
    def _run(self, params: SearchTransactionParams, *args, **kwargs) -> ToolResponse:
        ...
        try:
            ...
            return ToolResponse.ok({"transactions": result})
